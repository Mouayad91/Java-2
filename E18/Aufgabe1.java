...
public class Aufgabe1
{
    ...
    public static class NestedFakultaetFunktion implements MyFunction{ // Static nested Class            
           ...
           /*public static void main(String[] args) throws Aufgabe1Exception {
                NestedFakultaetFunktion nestedFakultaet = new NestedFakultaetFunktion();
                MyFunction fakultaet = nestedFakultaet::apply;
                Aufgabe1 berechnung = new Aufgabe1();
                berechnung.applyAndPrint(2,5,fakultaet);
           }*/
    }
    ...
    public static void main(String[] args) throws Aufgabe1Exception {
        ...
        Aufgabe1.NestedFakultaetFunktion nestedFakultaet = new Aufgabe1.NestedFakultaetFunktion();
        MyFunction fakultaet = nestedFakultaet::apply;
        obj.applyAndPrint(2,5,fakultaet);
    }
}
